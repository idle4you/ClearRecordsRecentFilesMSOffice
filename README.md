...
>as described, let's say [here](https://answers.microsoft.com/en-us/msoffice/forum/all/how-to-clear-recent-files-list-in-one-go/abebd56a-91eb-453a-87ae-703e680cb325), but it doesn't work on the latest versions of MS Office for Mac!
>
...
```
>
> как описано скажем вот [тут](https://answers.microsoft.com/en-us/msoffice/forum/all/how-to-clear-recent-files-list-in-one-go/abebd56a-91eb-453a-87ae-703e680cb325), но это не работает на последних версиях MS Office for Mac!
>
